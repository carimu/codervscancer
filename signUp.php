...
<form role="form" id="signUpForm" class="form-horizontal">
	<div class="center-block text-center">
		<div class="form-group">
			<label class="control-label col-sm-1 col-sm-offset-4" for="displayName">Display Name: </label>
			<div class="col-sm-3 col-sm-offset-0 col-xs-8 col-xs-offset-2">
				<input type="text" class="form-control" name="displayName" id="displayName" placeholder="Enter your Display Name" required>
			</div>
		</div>
		<div class="form-group">
